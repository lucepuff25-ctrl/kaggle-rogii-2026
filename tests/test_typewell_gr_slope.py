...
def test_typewell_gr_slope_rejects_nonfinite_rows() -> None:
    typewell = pd.DataFrame(
...
def test_typewell_gr_slope_rejects_rank_deficiency() -> None:
    typewell = pd.DataFrame({"TVT": [100.0, 100.0, 100.0], "GR": [1.0, 2.0, 3.0]})
